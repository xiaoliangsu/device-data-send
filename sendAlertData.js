...
client.on('connect', function () {
  ...
  // console.log(data);
	...
	var data = '{"hardwareId": "hard2", "type": "DeviceAlert","request": {"type": "engine.overheat","level": "Error","message": "The engine is about to overheat!! Turn the machine off!","updateState": true,"metadata":{"name1":"value1"}}}'
...
//   var data = '{"hardwareId": "hard3", "type": "DeviceAlert","request": {"measurements": { "gas.Pa":'+gasPa+',"water.Pa":'+waterPa+',"water.inTemper": '+inTemp+',"water.outTemper":'+outTemp+ ',"device.Temper": '+deviceTemp+'},"updateState": true}}';
//   console.log(data);
// client.publish('SiteWhere/input/json', data)
